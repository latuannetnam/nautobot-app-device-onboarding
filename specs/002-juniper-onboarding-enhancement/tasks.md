...
- [ ] T011 [US2] In the `JuniiperStandaloneOnboarding` class, update the `run` method to use the new Django models in `nautobot_device_onboarding/models` to store the Juniper-specific configuration data.
