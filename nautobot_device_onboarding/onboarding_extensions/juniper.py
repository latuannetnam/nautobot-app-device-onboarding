...
class JuniperOnboardingDriverExtensions(OnboardingDriverExtensions):
    """Juniper Onboarding Driver Extensions."""

    @property
    def onboarding_class(self):
        """Return onboarding class for Juniper driver."""
        return JuniperStandaloneOnboarding

    @property
    def ext_result(self):
        """Return Juniper-specific configuration data."""
        return None


class JuniperStandaloneOnboarding(StandaloneOnboarding):
    """Juniper Standalone Onboarding."""

    def run(self, onboarding_kwargs):
        """Ensure device is created with Nautobot Keeper."""
        super().run(onboarding_kwargs)
        # TODO: Add logic to store Juniper-specific configuration data
        # using the models in nautobot_device_onboarding/models.
