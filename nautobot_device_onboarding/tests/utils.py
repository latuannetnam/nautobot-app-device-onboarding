...
def setup_command_getter_logging(test_class_module_name):
    """Utility function to set up unified logging for command getter tests.
...
def cleanup_command_getter_logging(main_logger, etl_logger, handler):
